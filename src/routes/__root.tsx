...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TravelHub — Luxury Hotels, Flights & AI-Planned Trips" },
      { name: "description", content: "Book premium hotels, flights and AI-curated itineraries across the Middle East, Mediterranean and beyond." },
      { property: "og:title", content: "TravelHub — Your Next Adventure Starts Here" },
      { property: "og:description", content: "Premium travel booking for the discerning traveler." },
