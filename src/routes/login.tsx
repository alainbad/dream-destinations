...
import { BedDouble, Eye, EyeOff, ShieldCheck, BadgePercent, Headphones, Sparkles } from "lucide-react";
import { supabase } from "@/integrations/supabase/client";
import { lovable } from "@/integrations/lovable";
import { toast } from "sonner";

export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "Sign In — Dream Destinations" }] }),
  component: Login,
});
    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      <div className="relative bg-gradient-hero text-white p-10 lg:p-16 flex flex-col justify-between overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-white/85 mb-10 max-w-md">Pick up where you left off — your saved trips, bookings, and rewards are waiting.</p>
      ...
      <div className="flex items-center justify-center p-8 lg:p-16 bg-background">
        <form onSubmit={onSubmit} className="w-full max-w-md space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <Input id="pwd" type={show ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} className="h-11 pr-10" required />
