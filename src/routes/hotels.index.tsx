...
function HotelsPage() {
  const [price, setPrice] = useState([300, 2000]);
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-24 bg-gradient-hero text-white">
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <p className="mt-2 text-white/80">{hotels.length} handpicked properties across the globe</p>
        </div>
      </div>
              ...
              <div key={h.id} className="bg-card rounded-2xl shadow-card hover:shadow-elevated transition-all overflow-hidden border border-border/60 grid grid-cols-1 md:grid-cols-[320px_1fr]">
                ...
                <div className="p-6 flex flex-col">
                  ...
                  <div className="flex items-end justify-between mt-auto pt-5">
                    ...
                    <Button asChild className="bg-gradient-cta text-white border-0 shadow-glow"><Link to="/hotels/$id" params={{id:h.id}}>View Hotel</Link></Button>
                  </div>
                </div>
              </div>
            ))}
