    ...
    <footer className="bg-[oklch(0.14_0.03_255)] text-white/70 mt-24">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-2 md:grid-cols-5 gap-10">
        <div className="col-span-2">
          ...
          <p className="text-sm max-w-sm">
            Curated luxury hotels across the Middle East, Mediterranean and beyond.
            Book your stay with confidence and best-price guarantee.
          </p>
        ...
        {[
          { title: "Explore", items: ["Hotels", "AI Planner", "Destinations"] },
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-6 text-xs text-white/50 flex flex-wrap justify-between gap-2">
          <span>© 2026 Dream Destinations. All rights reserved.</span>
          <span>Curated stays, worldwide.</span>
        </div>
      </div>
    </footer>
  );
